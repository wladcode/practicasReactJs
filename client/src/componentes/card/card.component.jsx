        ...
        <div className="card-monster-container m-2">
            ...
            <div className="card-monster-content">
                ...
                <p className="card-monster-text">
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Deserunt cumque pariatur impedit
                    accusantium amet mollitia ad unde, qui praesentium excepturi architecto temporibus quasi facilis ab
                    quos cum incidunt maxime dignissimos.
                </p>
            </div>
