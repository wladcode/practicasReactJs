import { SHOP_DATA_ERROR, SHOP_DATA_START, SHOP_DATA_SUCCESS } from "../../../redux/shop/shop-actions";
...
describe("TEST SHOP REDUCER", () => {
    ...
    test("Test to set Collections", () => {
        expect(shopReducer(INITIAL_STATE, { type: SHOP_DATA_SUCCESS, payload: [] })).toEqual({
            collections: [],
            isFetching: false,
            errorMessage: undefined,
        });
